      ...
      <div class="side-navbar-wrapper">
        ...
        <div class="main-menu">
          ...
          <ul id="side-main-menu" class="side-menu list-unstyled">                  
            ...
            <li><a href="ongprojectAdmin.php"> <i class="icon-form"></i>on going project                            </a></li>
            <li><a href="charts.html"> <i class="fa fa-bar-chart"></i>company current profits                            </a></li>
            <li><a href="membershow.php"> <i class="icon-grid"></i>memberlist                            </a></li>
			<li><a href="adminProfile.php"> <i class="icon-grid"></i>Profile                            </a></li>
