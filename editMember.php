...
<html>
  ...
  <h4>Member information</h4>
       <form  method="post" enctype="multipart/form-data" action="editMemberData.php">
    ...
    <div class="form-group">
      <label>Email:</label>
      <input type="email" class="form-control" id="name" placeholder="Enter Email" name="email" value=" <?php
        require 'config.php';
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="password" placeholder="Enter password." name="password" value=" <?php
        require 'config.php';
	...
	<div class="form-group">
      ...
      <input type="text" class="form-control" id="Education" placeholder="Education" name="education" value=" <?php
        require 'config.php';
    ...
    ?>"">
           ...
           <div class="form-group">
      <label>Skills:</label>
      <input type="text" class="form-control" id="Skills" placeholder="Skills" name="skills" value=" <?php
        require 'config.php';
    ...
    ?>"">
      ...
      <input type="text" class="form-control" id="location" placeholder="location" name="location" value=" <?php
        require 'config.php';
